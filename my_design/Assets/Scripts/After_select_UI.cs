...
public class After_select_UI : MonoBehaviour
{
    ...
    IEnumerator TextPractice()
    {
        ...
        yield return StartCoroutine(NormalChat("이로써 너의 지팡이의 윤곽이 드러나기 시작했구나."));
    ...
    {
        {"earth","태초부터 존재했던 대지의 힘과"},{"fire","모든 인류문명의 시작점인 불의 힘과"},{"water","한때 권력의 상징이었던 얼음의 힘과"},{"wind","세상의 흐름을 느끼게 해준 바람의 힘과"},{"electric","현대 문명의 진정한 진화를 가져다준 전기의 힘과"},{"dark","머나 먼 우주의 깊은 두려움을 담은 암흑의 힘과"},{"light","어두운 세상 속에 하나의 길이 되어준 빛의 힘과"},{"illusion","어쩌면 우리가 가장 원하는 것을 가져다줄지 모르는 환각의 힘과"}
    };
    ...
    {
        {"earth","태초부터 존재했던 대지의 힘을 선택했구나"},{"fire","모든 인류문명의 시작점인 불을 선택했구나"},{"water","한때 권력의 상징이었던 얼음의 힘을 선택했구나"},{"wind","세상의 흐름을 느끼게 해준 바람의 힘을 선택했구나"},{"electric","현대 문명의 진정한 진화를 가져다준 전기의 힘을 선택했구나"},{"dark","머나 먼 우주의 깊은 두려움을 담은 암흑의 힘을 선택했구나"},{"light","어두운 세상 속에 하나의 길이 되어준 빛의 힘을 선택했구나"},{"illusion","어쩌면 우리가 가장 원하는 것을 가져다줄지 모르는 환각의 힘을 선택했구나"}
    };
